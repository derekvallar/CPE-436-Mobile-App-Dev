...
public class JokeContentProvider extends ContentProvider {
    ...
    public boolean onCreate() {
        database = new JokeDatabaseHelper(getContext(), BASE_PATH, null, 1);
        return true;
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (uriType) {
            ...
            case JOKE_ID:
                ...
                String where = JokeTable.JOKE_KEY_ID + "=" + lastPathSegment;
                numDeleted = sqlDB.delete(JokeTable.DATABASE_TABLE_JOKE, where, null);
                break;
    ...
    public int update(Uri uri, ContentValues values, String selection,
        ...
        switch (uriType) {
            ...
            case JOKE_ID:
                String lastPathSegment = uri.getLastPathSegment();
                String where = JokeTable.JOKE_KEY_ID + "=" + lastPathSegment;
                numUpdated = sqlDB.update(JokeTable.DATABASE_TABLE_JOKE, values, where, null);
                break;
